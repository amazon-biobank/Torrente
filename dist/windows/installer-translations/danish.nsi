...
LangString inst_qbt_req ${LANG_DANISH} "Torrente (påkrævet)"
...
LangString inst_startup ${LANG_DANISH} "Start Torrente i Windows opstart"
;LangString inst_torrent ${LANG_ENGLISH} "Open .torrent files with Torrente"
LangString inst_torrent ${LANG_DANISH} "Åbn .torrent-filer med Torrente"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with Torrente"
LangString inst_magnet ${LANG_DANISH} "Åbn magnet-links med Torrente"
...
LangString inst_warning ${LANG_DANISH} "Torrente kører. Luk venligst programmet inden installation."
...
LangString launch_qbt ${LANG_DANISH} "Start Torrente."
...
LangString inst_requires_win7 ${LANG_DANISH} "This Torrente version requires at least Windows 7."
...
LangString uninst_warning ${LANG_DANISH} "Torrente kører. Luk venligst programmet inden afinstallation."
