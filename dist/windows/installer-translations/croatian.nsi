...
LangString inst_qbt_req ${LANG_CROATIAN} "Torrente (neophodno)"
...
LangString inst_startup ${LANG_CROATIAN} "Pokrenite Torrente u sustavu Windows start up"
;LangString inst_torrent ${LANG_ENGLISH} "Open .torrent files with Torrente"
LangString inst_torrent ${LANG_CROATIAN} "Otvori .torrent datoteke s Torrenteom"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with Torrente"
LangString inst_magnet ${LANG_CROATIAN} "Otvori magnet linkove s Torrenteom"
...
LangString inst_warning ${LANG_CROATIAN} "Torrente je pokrenut. Zatvorite ga prije instalacije."
...
LangString launch_qbt ${LANG_CROATIAN} "Pokreni Torrente."
...
LangString inst_requires_win7 ${LANG_CROATIAN} "This Torrente version requires at least Windows 7."
...
LangString uninst_warning ${LANG_CROATIAN} "Torrente je pokrenut. Zatvorite ga prije deinstalacije."
