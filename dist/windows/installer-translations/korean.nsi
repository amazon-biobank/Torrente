...
LangString inst_qbt_req ${LANG_KOREAN} "Torrente (required)"
...
LangString inst_startup ${LANG_KOREAN} "Start Torrente on Windows start up"
;LangString inst_torrent ${LANG_ENGLISH} "Open .torrent files with Torrente"
LangString inst_torrent ${LANG_KOREAN} "Open .torrent files with Torrente"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with Torrente"
LangString inst_magnet ${LANG_KOREAN} "Open magnet links with Torrente"
...
LangString inst_warning ${LANG_KOREAN} "Torrente is running. Please close the application before installing."
...
LangString launch_qbt ${LANG_KOREAN} "Launch Torrente."
...
LangString inst_requires_win7 ${LANG_KOREAN} "This Torrente version requires at least Windows 7."
...
LangString uninst_warning ${LANG_KOREAN} "Torrente is running. Please close the application before uninstalling."
