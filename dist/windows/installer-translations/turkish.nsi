...
LangString inst_qbt_req ${LANG_TURKISH} "Torrente (zorunlu)"
...
LangString inst_startup ${LANG_TURKISH} "Windows başlangıcında Torrente'i başlat"
;LangString inst_torrent ${LANG_ENGLISH} "Open .torrent files with Torrente"
LangString inst_torrent ${LANG_TURKISH} ".torrent dosyalarını Torrente ile aç"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with Torrente"
LangString inst_magnet ${LANG_TURKISH} "Magnet bağlantılarını Torrente ile aç"
...
LangString inst_warning ${LANG_TURKISH} "Torrente çalışıyor. Lütfen yüklemeden önce uygulamayı kapatın."
...
LangString launch_qbt ${LANG_TURKISH} "Torrente'i başlat"
...
LangString inst_requires_win7 ${LANG_TURKISH} "Bu Torrente sürümü en az Windows 7 gerektirir."
...
LangString uninst_warning ${LANG_TURKISH} "Torrente çalışıyor. Lütfen kaldırmadan önce uygulamayı kapatın."
