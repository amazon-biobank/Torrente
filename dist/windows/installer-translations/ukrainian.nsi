...
LangString inst_qbt_req ${LANG_UKRAINIAN} "Torrente (необхідний)"
...
LangString inst_startup ${LANG_UKRAINIAN} "Запустіть Torrente в Windows"
;LangString inst_torrent ${LANG_ENGLISH} "Open .torrent files with Torrente"
LangString inst_torrent ${LANG_UKRAINIAN} "Відкривати .torrent файли за допомогою Torrente"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with Torrente"
LangString inst_magnet ${LANG_UKRAINIAN} "Відкривати посилання magnet за допомогою Torrente"
...
LangString inst_warning ${LANG_UKRAINIAN} "Torrente вже виконується. Будь ласка, закрийте застосунок перед запуском інсталятору."
...
LangString launch_qbt ${LANG_UKRAINIAN} "Запустити Torrente."
...
LangString inst_requires_win7 ${LANG_UKRAINIAN} "This Torrente version requires at least Windows 7."
...
LangString uninst_warning ${LANG_UKRAINIAN} "Torrente виконується. Будь ласка, закрийте застосунок перед деінсталляцією."
