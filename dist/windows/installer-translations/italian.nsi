...
LangString inst_qbt_req ${LANG_ITALIAN} "Torrente (necessario)"
...
LangString inst_startup ${LANG_ITALIAN} "Esegui Torrente all'avvio di Windows"
;LangString inst_torrent ${LANG_ENGLISH} "Open .torrent files with Torrente"
LangString inst_torrent ${LANG_ITALIAN} "Apri file .torrent con Torrente"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with Torrente"
LangString inst_magnet ${LANG_ITALIAN} "Apri collegamenti magnet con Torrente"
...
LangString inst_warning ${LANG_ITALIAN} "Torrente è in esecuzione. Chiudilo prima di procedere con l'installazione."
...
LangString launch_qbt ${LANG_ITALIAN} "Esegui Torrente."
...
LangString inst_requires_win7 ${LANG_ITALIAN} "Questa versione di Torrente richiede Windows 7 o versioni successive."
...
LangString uninst_warning ${LANG_ITALIAN} "Torrente è in esecuzione. Chiudilo prima di procedere con la disinstallazione."
