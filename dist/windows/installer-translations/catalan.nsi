...
LangString inst_qbt_req ${LANG_CATALAN} "Torrente (required)"
...
LangString inst_startup ${LANG_CATALAN} "Start Torrente on Windows start up"
;LangString inst_torrent ${LANG_ENGLISH} "Open .torrent files with Torrente"
LangString inst_torrent ${LANG_CATALAN} "Open .torrent files with Torrente"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with Torrente"
LangString inst_magnet ${LANG_CATALAN} "Open magnet links with Torrente"
...
LangString inst_warning ${LANG_CATALAN} "Torrente is running. Please close the application before installing."
...
LangString launch_qbt ${LANG_CATALAN} "Launch Torrente."
...
LangString inst_requires_win7 ${LANG_CATALAN} "This Torrente version requires at least Windows 7."
...
LangString uninst_warning ${LANG_CATALAN} "Torrente is running. Please close the application before uninstalling."
