...
LangString inst_qbt_req ${LANG_FRENCH} "Torrente (requis)"
...
LangString inst_startup ${LANG_FRENCH} "Démarrez Torrente au démarrage de Windows"
;LangString inst_torrent ${LANG_ENGLISH} "Open .torrent files with Torrente"
LangString inst_torrent ${LANG_FRENCH} "Ouvrir fichiers .torrent avec Torrente"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with Torrente"
LangString inst_magnet ${LANG_FRENCH} "Ouvrir liens magnet avec Torrente"
...
LangString inst_warning ${LANG_FRENCH} "Torrente est en cours d'exécution. Veuillez fermer l'application avant l'installation."
...
LangString launch_qbt ${LANG_FRENCH} "Lancer Torrente."
...
LangString inst_requires_win7 ${LANG_FRENCH} "Cette version de Torrente nécessite au moins Windows 7."
...
LangString uninst_warning ${LANG_FRENCH} "Torrente est en cours d'exécution. Veuillez fermer l'application avant la désinstallation."
