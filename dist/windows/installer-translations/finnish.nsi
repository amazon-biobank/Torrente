...
LangString inst_qbt_req ${LANG_FINNISH} "Torrente (pakollinen)"
...
LangString inst_startup ${LANG_FINNISH} "Käynnistä Torrente Windowsin käynnistyessä"
;LangString inst_torrent ${LANG_ENGLISH} "Open .torrent files with Torrente"
LangString inst_torrent ${LANG_FINNISH} "Avaa .torrent tiedostot Torrenteilla"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with Torrente"
LangString inst_magnet ${LANG_FINNISH} "Avaa magnet-linkit Torrenteilla"
...
LangString inst_warning ${LANG_FINNISH} "Torrente on käynnissä. Sulje ohjelma ennen asennusta."
...
LangString launch_qbt ${LANG_FINNISH} "Käynnistä Torrente."
...
LangString inst_requires_win7 ${LANG_FINNISH} "Tämä Torrente versio tarvitsee vähintään Windows 7:n."
...
LangString uninst_warning ${LANG_FINNISH} "Torrente on käynnissä. Sulje ohjelma ennen poistamista."
