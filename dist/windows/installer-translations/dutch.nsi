...
LangString inst_qbt_req ${LANG_DUTCH} "Torrente (vereist)"
...
LangString inst_startup ${LANG_DUTCH} "Torrente starten bij opstarten van Windows"
;LangString inst_torrent ${LANG_ENGLISH} "Open .torrent files with Torrente"
LangString inst_torrent ${LANG_DUTCH} "Torrentbestanden openen met Torrente"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with Torrente"
LangString inst_magnet ${LANG_DUTCH} "Magneetkoppelingen openen met Torrente"
...
LangString inst_warning ${LANG_DUTCH} "Torrente is actief. Sluit het af voordat u deze update installeert."
...
LangString launch_qbt ${LANG_DUTCH} "Torrente starten."
...
LangString inst_requires_win7 ${LANG_DUTCH} "Deze versie van Torrente vereist ten minste Windows 7."
...
LangString uninst_warning ${LANG_DUTCH} "Torrente is actief. Sluit het af voordat u het verwijdert."
