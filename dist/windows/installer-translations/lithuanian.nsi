...
LangString inst_qbt_req ${LANG_LITHUANIAN} "Torrente (reikalingas)"
...
LangString inst_startup ${LANG_LITHUANIAN} "Pradėti „Torrente“ paleidus „Windows“"
;LangString inst_torrent ${LANG_ENGLISH} "Open .torrent files with Torrente"
LangString inst_torrent ${LANG_LITHUANIAN} "Atidaryti .torrent failus su Torrente"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with Torrente"
LangString inst_magnet ${LANG_LITHUANIAN} "Atidaryti magneto nuorodas su Torrente"
...
LangString inst_warning ${LANG_LITHUANIAN} "Torrente yra paleistas. Prašau uždaryti programą prieš įdiegiant."
...
LangString launch_qbt ${LANG_LITHUANIAN} "Paleisti Torrente."
...
LangString inst_requires_win7 ${LANG_LITHUANIAN} "This Torrente version requires at least Windows 7."
...
LangString uninst_warning ${LANG_LITHUANIAN} "Torrente yra paleistas. Prašau uždarykite programą prieš išdiegiant."
