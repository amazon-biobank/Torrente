...
LangString inst_qbt_req ${LANG_ESTONIAN} "Torrente (vajalik)"
...
LangString inst_startup ${LANG_ESTONIAN} "Käivita Torrente Windowsi käivitamisel"
;LangString inst_torrent ${LANG_ENGLISH} "Open .torrent files with Torrente"
LangString inst_torrent ${LANG_ESTONIAN} "Ava .torrent failid Torrenteiga"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with Torrente"
LangString inst_magnet ${LANG_ESTONIAN} "Ava magnet lingid Torrenteiga"
...
LangString inst_warning ${LANG_ESTONIAN} "Torrente töötab. Palun sulge see programm, enne installi."
...
LangString launch_qbt ${LANG_ESTONIAN} "Käivita Torrente."
...
LangString inst_requires_win7 ${LANG_ESTONIAN} "Selle Torrentei versiooni jaoks on vajalik vähemalt Windows 7."
...
LangString uninst_warning ${LANG_ESTONIAN} "Torrente töötab. Palun sulge programm, enne uninstallimist."
