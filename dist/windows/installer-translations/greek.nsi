...
LangString inst_qbt_req ${LANG_GREEK} "Torrente (απαιτείται)"
...
LangString inst_startup ${LANG_GREEK} "Ξεκινήστε το Torrente στα Windows"
;LangString inst_torrent ${LANG_ENGLISH} "Open .torrent files with Torrente"
LangString inst_torrent ${LANG_GREEK} "Άνοιγμα των αρχείων .torrent με το Torrente"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with Torrente"
LangString inst_magnet ${LANG_GREEK} "Άνοιγμα των μαγνητικών συνδέσμων με το Torrente"
...
LangString inst_warning ${LANG_GREEK} "Το Torrente βρίσκεται σε εκτέλεση. Παρακαλούμε κλείστε την εφαρμογή πριν την εγκατάσταση."
...
LangString launch_qbt ${LANG_GREEK} "Εκκίνηση του Torrente."
...
LangString inst_requires_win7 ${LANG_GREEK} "This Torrente version requires at least Windows 7."
...
LangString uninst_warning ${LANG_GREEK} "Το Torrente βρίσκεται σε εκτέλεση. Παρακαλούμε κλείστε την εφαρμογή πριν την απεγκατάσταση."
