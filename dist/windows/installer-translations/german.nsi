...
LangString inst_qbt_req ${LANG_GERMAN} "Torrente (erforderlich)"
...
LangString inst_startup ${LANG_GERMAN} "Torrente mit Windows mitstarten"
;LangString inst_torrent ${LANG_ENGLISH} "Open .torrent files with Torrente"
LangString inst_torrent ${LANG_GERMAN} "Öffne .torrent-Dateien mit Torrente"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with Torrente"
LangString inst_magnet ${LANG_GERMAN} "Öffne Magnet-Links mit Torrente"
...
LangString inst_warning ${LANG_GERMAN} "Torrente läuft gerade. Bitte das Programm vor der Installation beenden."
...
LangString launch_qbt ${LANG_GERMAN} "Starte Torrente."
...
LangString inst_requires_win7 ${LANG_GERMAN} "Diese Version von Torrente erfordert zumindest Windows 7."
...
LangString uninst_warning ${LANG_GERMAN} "Torrente läuft gerade. Bitte das Programm vor der Deinstallation beenden."
