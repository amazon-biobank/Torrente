...
LangString inst_qbt_req ${LANG_IRISH} "Torrente (required)"
...
LangString inst_startup ${LANG_IRISH} "Start Torrente on Windows start up"
;LangString inst_torrent ${LANG_ENGLISH} "Open .torrent files with Torrente"
LangString inst_torrent ${LANG_IRISH} "Open .torrent files with Torrente"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with Torrente"
LangString inst_magnet ${LANG_IRISH} "Open magnet links with Torrente"
...
LangString inst_warning ${LANG_IRISH} "Torrente is running. Please close the application before installing."
...
LangString launch_qbt ${LANG_IRISH} "Launch Torrente."
...
LangString inst_requires_win7 ${LANG_IRISH} "This Torrente version requires at least Windows 7."
...
LangString uninst_warning ${LANG_IRISH} "Torrente is running. Please close the application before uninstalling."
