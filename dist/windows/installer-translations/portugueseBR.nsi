...
LangString inst_qbt_req ${LANG_PORTUGUESEBR} "Torrente (requerido)"
...
LangString inst_startup ${LANG_PORTUGUESEBR} "Iniciar o Torrente na inicialização do Windows"
;LangString inst_torrent ${LANG_ENGLISH} "Open .torrent files with Torrente"
LangString inst_torrent ${LANG_PORTUGUESEBR} "Abrir arquivos .torrent com Torrente"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with Torrente"
LangString inst_magnet ${LANG_PORTUGUESEBR} "Abrir links magnéticos com Torrente"
...
LangString inst_warning ${LANG_PORTUGUESEBR} "Torrente está rodando. Por favor feche a aplicação antes de instalar."
...
LangString launch_qbt ${LANG_PORTUGUESEBR} "Executar Torrente."
...
LangString inst_requires_win7 ${LANG_PORTUGUESEBR} "Esta versão do Torrente requer no mínimo o Windows 7."
...
LangString uninst_warning ${LANG_PORTUGUESEBR} "Torrente está rodando. Por favor feche a aplicação antes de desinstalar."
