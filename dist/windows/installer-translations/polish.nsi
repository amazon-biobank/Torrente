...
LangString inst_qbt_req ${LANG_POLISH} "Torrente (required)"
...
LangString inst_startup ${LANG_POLISH} "Start Torrente on Windows start up"
;LangString inst_torrent ${LANG_ENGLISH} "Open .torrent files with Torrente"
LangString inst_torrent ${LANG_POLISH} "Open .torrent files with Torrente"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with Torrente"
LangString inst_magnet ${LANG_POLISH} "Open magnet links with Torrente"
...
LangString inst_warning ${LANG_POLISH} "Torrente is running. Please close the application before installing."
...
LangString launch_qbt ${LANG_POLISH} "Launch Torrente."
...
LangString inst_requires_win7 ${LANG_POLISH} "This Torrente version requires at least Windows 7."
...
LangString uninst_warning ${LANG_POLISH} "Torrente is running. Please close the application before uninstalling."
