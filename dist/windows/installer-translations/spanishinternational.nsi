...
LangString inst_qbt_req ${LANG_SPANISHINTERNATIONAL} "Torrente (necesario)"
...
LangString inst_startup ${LANG_SPANISHINTERNATIONAL} "Inicie Torrente en el inicio de Windows"
;LangString inst_torrent ${LANG_ENGLISH} "Open .torrent files with Torrente"
LangString inst_torrent ${LANG_SPANISHINTERNATIONAL} "Abrir archivos .torrent con Torrente"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with Torrente"
LangString inst_magnet ${LANG_SPANISHINTERNATIONAL} "Abrir enlaces magnet con Torrente"
...
LangString inst_warning ${LANG_SPANISHINTERNATIONAL} "Torrente se está ejecutando. Ciérrelo antes de continuar."
...
LangString launch_qbt ${LANG_SPANISHINTERNATIONAL} "Iniciar Torrente."
...
LangString inst_requires_win7 ${LANG_SPANISHINTERNATIONAL} "This Torrente version requires at least Windows 7."
...
LangString uninst_warning ${LANG_SPANISHINTERNATIONAL} "Torrente se está ejecutando. Ciérrelo antes de continuar."
