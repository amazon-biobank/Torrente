...
1. Open the options.nsi file in an editor and change line that contains
   "!define PROG_VERSION "3.0.3"" to the version of torrente you just built.
...
3. The script you need to compile is "torrente.nsi". It includes all other necessary scripts.
...
6. "torrente.exe" is the compiled binary file.
