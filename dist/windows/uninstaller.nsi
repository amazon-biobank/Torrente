...
Section "un.$(remove_associations)" ;"un.Remove file associations"
  ...
  StrCmp $0 '"$INSTDIR\Torrente.exe" "%1"' 0 magnet_end
...
Section "un.$(remove_registry)" ;"un.Remove registry keys"
  ...
  DeleteRegKey HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\Torrente"
  DeleteRegKey HKLM "Software\Torrente"
  DeleteRegKey HKLM "Software\Classes\Torrente"
