...
6. Qt headers
7. Torrente's own headers, starting from the *base* headers.
...
If there are conditionals that contain headers from several different header groups, then put them above the "Torrente's own headers" group.
