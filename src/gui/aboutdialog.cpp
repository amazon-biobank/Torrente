    ...
    , m_storeDialogSize(SETTINGS_KEY("Size"))
{
    ...
    // Title
    m_ui->labelName->setText(QString::fromLatin1("<b><h2>Torrente " QBT_VERSION " (%1-bit)</h2></b>").arg(QT_POINTER_SIZE * 8));

    m_ui->logo->setPixmap(Utils::Gui::scaledPixmapSvg(UIThemeManager::instance()->getIconPath(QLatin1String("torrente-tray")), this, 32));
    ...
    const QString aboutText = QString(
        ...
        "%2\n\n"
        "<table>"
        "<tr><td>%3</td><td><a href=\"https://www.torrente.org\">https://www.torrente.org</a></td></tr>"
        "<tr><td>%4</td><td><a href=\"http://forum.torrente.org\">http://forum.torrente.org</a></td></tr>"
        "<tr><td>%5</td><td><a href=\"http://bugs.torrente.org\">http://bugs.torrente.org</a></td></tr>"
        "</table>"
        "</p>")
        .arg(tr("An advanced BitTorrent client programmed in C++, based on Qt toolkit and libtorrent-rasterbar.")
            , tr("Copyright %1 2006-2021 The Torrente project").arg(QString::fromUtf8(C_COPYRIGHT))
            , tr("Home Page:")
            , tr("Forum:")
            , tr("Bug Tracker:"));
