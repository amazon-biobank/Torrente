...
window.Torrente.PropGeneral = (function() {
    ...
    const loadTorrentData = function() {
        ...
        new Request.JSON({
            ...
            method: 'get',
            onFailure: function() {
                $('error_div').set('html', 'QBT_TR(Torrente client is not reachable)QBT_TR[CONTEXT=HttpServer]');
                clearTimeout(loadTorrentDataTimer);
            ...
            onSuccess: function(data) {
                ...
                if (data) {
                    ...
                    if (data.seeding_time > 0)
                        ...
                        .replace("%1", window.Torrente.Misc.friendlyDuration(data.time_elapsed))
                        .replace("%2", window.Torrente.Misc.friendlyDuration(data.seeding_time));
                    else
                        temp = window.Torrente.Misc.friendlyDuration(data.time_elapsed);
                    $('time_elapsed').set('html', temp);

                    $('eta').set('html', window.Torrente.Misc.friendlyDuration(data.eta));
                    ...
                    temp = "QBT_TR(%1 (%2 this session))QBT_TR[CONTEXT=PropertiesWidget]"
                        .replace("%1", window.Torrente.Misc.friendlyUnit(data.total_downloaded))
                        .replace("%2", window.Torrente.Misc.friendlyUnit(data.total_downloaded_session));
                    $('total_downloaded').set('html', temp);

                    temp = "QBT_TR(%1 (%2 this session))QBT_TR[CONTEXT=PropertiesWidget]"
                        .replace("%1", window.Torrente.Misc.friendlyUnit(data.total_uploaded))
                        .replace("%2", window.Torrente.Misc.friendlyUnit(data.total_uploaded_session));
                    $('total_uploaded').set('html', temp);

                    temp = "QBT_TR(%1 (%2 avg.))QBT_TR[CONTEXT=PropertiesWidget]"
                        .replace("%1", window.Torrente.Misc.friendlyUnit(data.dl_speed, true))
                        .replace("%2", window.Torrente.Misc.friendlyUnit(data.dl_speed_avg, true));
                    $('dl_speed').set('html', temp);

                    temp = "QBT_TR(%1 (%2 avg.))QBT_TR[CONTEXT=PropertiesWidget]"
                        .replace("%1", window.Torrente.Misc.friendlyUnit(data.up_speed, true))
                        .replace("%2", window.Torrente.Misc.friendlyUnit(data.up_speed_avg, true));
                    $('up_speed').set('html', temp);

                    temp = (data.dl_limit == -1 ? "∞" : window.Torrente.Misc.friendlyUnit(data.dl_limit, true));
                    $('dl_limit').set('html', temp);

                    temp = (data.up_limit == -1 ? "∞" : window.Torrente.Misc.friendlyUnit(data.up_limit, true));
                    $('up_limit').set('html', temp);

                    $('total_wasted').set('html', window.Torrente.Misc.friendlyUnit(data.total_wasted));
                    ...
                    $('reannounce').set('html', window.Torrente.Misc.friendlyDuration(data.reannounce));
                    ...
                    $('total_size').set('html', window.Torrente.Misc.friendlyUnit(data.total_size));

                    if (data.pieces_num != -1)
                        temp = "QBT_TR(%1 x %2 (have %3))QBT_TR[CONTEXT=PropertiesWidget]"
                        .replace("%1", data.pieces_num)
                        .replace("%2", window.Torrente.Misc.friendlyUnit(data.piece_size))
                    ...
                    $('comment').set('html', window.Torrente.Misc.parseHtmlLinks(window.Torrente.Misc.escapeHtml(data.comment)));
                }
                else {
                    clearData();
                }
