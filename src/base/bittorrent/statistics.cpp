...
void Statistics::save() const
{
    ...
    SettingsPtr s = Profile::instance()->applicationSettings(QLatin1String("Torrente-data"));
    QVariantHash v;
...
{
    const SettingsPtr s = Profile::instance()->applicationSettings(QLatin1String("Torrente-data"));
