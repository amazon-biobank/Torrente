 ...
 * Copyright (C) 2010  Arnaud Demaiziere <arnaud@torrente.org>
 *
...
{
    const SettingsPtr qBTRSSFeeds = Profile::instance()->applicationSettings(QStringLiteral("Torrente-rss-feeds"));
